...
-- Retorna uma relação mensal de preço e/ou quantidade de roupas vendidas no ano de 2015;
SELECT 
    tb_produto.nome,
...
GROUP BY mes , tb_produto.nome;

-- Retorna uma relação mensal de preço e/ou quantidade de bebidas vendidas no ano de 2015;
SELECT 
    tb_produto.nome,
    MONTH(data_hora) AS mes,
    SUM(preco_total) AS receita_mensal,
...
-- Retorna uma relação mensal de preço e/ou quantidade de mídias vendidas no ano de 2015;
SELECT 
    tb_produto.nome,
    MONTH(data_hora) AS mes,
    SUM(preco_total) AS receita_mensal,
